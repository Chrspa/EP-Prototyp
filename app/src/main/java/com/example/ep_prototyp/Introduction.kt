...
class Introduction : Fragment() {
    ...
    override fun onCreateView(
        ...
        val list = listOf<String>(
            ...
            "Das funktioniert so:\n\n" +
                    "Du fängst mit kleinen Verhaltensänderungen an, findest heraus, wie du diese in deinen Alltag integrieren und bringst sie durch stetige positive Bestärkung zur vollen Entfaltung.",
            "Das funktioniert so:\n\n" +
            "Die Verhalten sind so klein und einfach, dass du dich nicht mit viel Aufwand dazu motivieren musst. Es geht darum, nach und nach neue Gewohnheiten entstehen zu lassen.\n",
